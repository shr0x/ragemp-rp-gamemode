...
function getString(buffer: any, offset: any, length = 64) {
    // @ts-ignore
...
function getTattooCollectionData(characterType: any, decorationIndex: any) {
...
function getPedHeadBlendData(entityOrHandle: any) {
    ...
    const { 0: shapeFirstId, 2: shapeSecondId, 4: shapeThirdId, 6: skinFirstId, 8: skinSecondId, 10: skinThirdId, 18: isParent } = new Uint32Array(buffer[0]);
...
function getWeaponHudStats(weaponHash: any) {
...
function getWeaponComponentHudStats(componentHash: any) {
    let buffer = [new ArrayBuffer(40)];
...
function getDlcWeaponData(dlcWeaponIndex: any) {
...
function getDlcWeaponComponentData(dlcWeaponIndex: any, dlcWeaponComponentIndex: any) {
