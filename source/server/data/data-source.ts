...
import { DatabaseLogger } from "../data/database-logger";
import { BanEntity } from "../database/entities/Ban.entity";

import * as dotenv from "dotenv";
import { InventoryItemsEntity } from "../database/entities/Inventory.entity";
...
export const MainDataSource = new DataSource({
    ...
    logging: ["error"],
    entities: [AccountEntity, CharacterEntity, BankAccountEntity, BanEntity, InventoryItemsEntity, VehicleEntity, HouseEntity],
    migrations: [],
    subscribers: [],
